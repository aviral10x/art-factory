export const NFTProgramId = 'privacy_pride_nft_test111.aleo';

export const NFTProgram = `program privacy_pride_nft_test111.aleo;
...
function initialize_collection:
    ...
    assert.eq self.caller aleo1pqhmanmrycg2k8q93va4k7r23leecd7jrjevevqffqea7eq77yrs8y9pqw;
    async initialize_collection r0 r1 r2 into r3;
    output r3 as privacy_pride_nft_test111.aleo/initialize_collection.future;
...
function add_nft:
    ...
    output r4 as privacy_pride_nft_test111.aleo/add_nft.future;
...
function add_minter:
    ...
    output r3 as privacy_pride_nft_test111.aleo/add_minter.future;
...
function update_toggle_settings:
    ...
    output r1 as privacy_pride_nft_test111.aleo/update_toggle_settings.future;
...
function set_mint_block:
    ...
    output r1 as privacy_pride_nft_test111.aleo/set_mint_block.future;
...
function update_symbol:
    ...
    output r1 as privacy_pride_nft_test111.aleo/update_symbol.future;
...
function update_base_uri:
    ...
    output r1 as privacy_pride_nft_test111.aleo/update_base_uri.future;
...
function open_mint:
    ...
    output r4 as privacy_pride_nft_test111.aleo/open_mint.future;
...
function mint:
    ...
    output r7 as privacy_pride_nft_test111.aleo/mint.future;
...
function claim_nft:
    ...
    output r6 as privacy_pride_nft_test111.aleo/claim_nft.future;
...
function authorize:
    ...
    output r2 as privacy_pride_nft_test111.aleo/authorize.future;
...
function transfer_public:
    ...
    output r5 as privacy_pride_nft_test111.aleo/transfer_public.future;
...
function convert_private_to_public:
    ...
    output r3 as privacy_pride_nft_test111.aleo/convert_private_to_public.future;
...
function convert_public_to_private:
    ...
    output r5 as NFT.record;
    output r6 as privacy_pride_nft_test111.aleo/convert_public_to_private.future;
